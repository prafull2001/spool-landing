...
export const metadata = {
  title: "How to Stop Doom Scrolling: 10 Proven Strategies That Work | Spool",
  description: "Read about How to Stop Doom Scrolling: 10 Proven Strategies That Work on the Spool blog.",
};

# How to Stop Doom Scrolling: 10 Proven Strategies That Work
*February 8, 2026*
