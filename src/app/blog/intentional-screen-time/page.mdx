...
export const metadata = {
  title: "Transform Screen Time Into Intentional Time | Spool",
  description: "Read about Transform Screen Time Into Intentional Time on the Spool blog.",
};

# Transform Screen Time Into Intentional Time
*October 9, 2024*
