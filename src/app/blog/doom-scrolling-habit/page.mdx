...
export const metadata = {
  title: "How Spool Breaks Your Doom Scrolling Habit | Spool",
  description: "Read about How Spool Breaks Your Doom Scrolling Habit on the Spool blog.",
};

# How Spool Breaks Your Doom Scrolling Habit
*October 9, 2024*
