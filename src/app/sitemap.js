...
export default function sitemap() {
  ...
  return [
    ...
    { url: `${baseUrl}/focus-web`, lastModified: '2026-07-31', changeFrequency: 'monthly', priority: 0.9 },
    { url: `${baseUrl}/focus-web/instagram-without-reels`, lastModified: '2026-07-31', changeFrequency: 'monthly', priority: 0.8 },
    { url: `${baseUrl}/focus-web/youtube-without-shorts`, lastModified: '2026-07-31', changeFrequency: 'monthly', priority: 0.8 },
    { url: `${baseUrl}/focus-web/x-without-explore`, lastModified: '2026-07-31', changeFrequency: 'monthly', priority: 0.8 },
    { url: `${baseUrl}/focus-web/snapchat-without-spotlight`, lastModified: '2026-07-31', changeFrequency: 'monthly', priority: 0.8 },
